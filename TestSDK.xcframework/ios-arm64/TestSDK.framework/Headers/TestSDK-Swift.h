...
#ifndef TESTSDK_SWIFT_H
#define TESTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TestSDK11AlphaSlider") SWIFT_AVAILABILITY(ios,introduced=10.0)
...
SWIFT_CLASS("_TtC7TestSDK10DashedView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TestSDK18IBDesignableButton")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TestSDK16IBDesignableView")
...
SWIFT_CLASS("_TtC7TestSDK24OpenISO8601DateFormatter")
...
SWIFT_CLASS("_TtC7TestSDK6Router")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TestSDK24SecondIBDesignableButton")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC7TestSDK14SegmentControl")
...
@interface UIViewController (SWIFT_EXTENSION(TestSDK))
- (void)awakeFromNib;
@end
